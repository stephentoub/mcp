...
internal sealed partial class AIFunctionMcpServerTool : McpServerTool
{
    ...
    internal static string DeriveName(MethodInfo method, JsonNamingPolicy? policy)
    {
        ...
        // Remove any "Async" suffix if the method is an async method.
        ...
        // Remove anything other than ASCII letters, digits, or underscores.
        name = InvalidNameCharsRegex().Replace(name, "_").Trim('_');
