...
public class McpServerBuilderExtensionsPromptsTests : LoggedTest, IAsyncDisposable
{
        ...
        : base(testOutputHelper)
    {
        ...
        _builder = sc.AddMcpServer().WithPrompts<SimplePrompts>();
    ...
    {
        var prompts = _server.ServerOptions?.Capabilities?.Prompts?.PromptCollection;
    ...
    public async Task Can_Be_Notified_Of_Prompt_Changes()
    {
        ...
        var serverPrompts = _server.ServerOptions.Capabilities?.Prompts?.PromptCollection;
